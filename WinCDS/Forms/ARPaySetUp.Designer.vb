...
Partial Class ARPaySetUp
    ...
    Private Sub InitializeComponent()
        ...
        Me.fraARPaySetup.Controls.Add(Me.chkLife)
        Me.fraARPaySetup.Controls.Add(Me.lblTotal)
        Me.fraARPaySetup.Controls.Add(Me.lblTotalCaption)
        Me.fraARPaySetup.Controls.Add(Me.txtBalDueLateCharge)
        Me.fraARPaySetup.Controls.Add(Me.lblBalDueLateCharge)
        Me.fraARPaySetup.Controls.Add(Me.txtAddlPaymentsMade)
        Me.fraARPaySetup.Controls.Add(Me.lblAddlPayments)
        Me.fraARPaySetup.Controls.Add(Me.chkRoundUp)
        Me.fraARPaySetup.Controls.Add(Me.txtPaymentWillBe)
        Me.fraARPaySetup.Controls.Add(Me.txtTotalBalance)
        Me.fraARPaySetup.Controls.Add(Me.txtFinanceChargeSalesTax)
        Me.fraARPaySetup.Controls.Add(Me.lblAcctNo)
        Me.fraARPaySetup.Controls.Add(Me.lblPaymentWillBe)
        Me.fraARPaySetup.Controls.Add(Me.lblTotalBalance)
        Me.fraARPaySetup.Controls.Add(Me.lblFinanceChargeSalesTax)
        Me.fraARPaySetup.Controls.Add(Me.txtFinanceCharges)
        Me.fraARPaySetup.Controls.Add(Me.txtDeferredInt)
        Me.fraARPaySetup.Controls.Add(Me.cboCashOption)
        Me.fraARPaySetup.Controls.Add(Me.txtFinanceAmount)
        Me.fraARPaySetup.Controls.Add(Me.txtMonthsToFinance)
        Me.fraARPaySetup.Controls.Add(Me.lblFinanceCharges)
        Me.fraARPaySetup.Controls.Add(Me.lblDeferredInt)
        Me.fraARPaySetup.Controls.Add(Me.lblCashOpt)
        Me.fraARPaySetup.Controls.Add(Me.lblFinanceAmount)
        Me.fraARPaySetup.Controls.Add(Me.lblMonthsToFinance)
        Me.fraARPaySetup.Controls.Add(Me.txtUnemploymentInsurance)
        Me.fraARPaySetup.Controls.Add(Me.txtPropertyInsurance)
        Me.fraARPaySetup.Controls.Add(Me.txtAccidentInsurance)
        Me.fraARPaySetup.Controls.Add(Me.txtLifeInsurance)
        Me.fraARPaySetup.Controls.Add(Me.txtDocFee)
        Me.fraARPaySetup.Controls.Add(Me.lblUnemploymentInsurance)
        Me.fraARPaySetup.Controls.Add(Me.lblPropertyInsurance)
        Me.fraARPaySetup.Controls.Add(Me.lblAccidentInsurance)
        Me.fraARPaySetup.Controls.Add(Me.lblLifeInsurance)
        Me.fraARPaySetup.Controls.Add(Me.lblDocFee)
        Me.fraARPaySetup.Controls.Add(Me.txtSubTotal)
        Me.fraARPaySetup.Controls.Add(Me.txtOrigDeposit)
        Me.fraARPaySetup.Controls.Add(Me.txtGrossSale)
        Me.fraARPaySetup.Controls.Add(Me.txtPrevBalance)
        Me.fraARPaySetup.Controls.Add(Me.lblSubTotal)
        Me.fraARPaySetup.Controls.Add(Me.lblOrigDeposit)
        Me.fraARPaySetup.Controls.Add(Me.lblGrossSale)
        Me.fraARPaySetup.Controls.Add(Me.lblPrevBal)
        Me.fraARPaySetup.Controls.Add(Me.txtArNo)
        Me.fraARPaySetup.Controls.Add(Me.chkAutoARNO)
        Me.fraARPaySetup.Controls.Add(Me.fraLateChargesApplied)
        Me.fraARPaySetup.Controls.Add(Me.picPicture)
        Me.fraARPaySetup.Controls.Add(Me.lblFirstPaymentDue)
        ...
        Me.lblFirstPaymentDue.Location = New System.Drawing.Point(113, 47)
        ...
        Me.lblDelDate.Location = New System.Drawing.Point(116, 25)
        ...
        Me.dteDate2.Location = New System.Drawing.Point(32, 41)
        ...
        Me.dteDate1.Location = New System.Drawing.Point(32, 19)
    ...
    Friend WithEvents fraARPaySetup As GroupBox
    ...
    Friend WithEvents chkRoundUp As CheckBox
    Friend WithEvents txtPaymentWillBe As TextBox
    Friend WithEvents txtTotalBalance As TextBox
    Friend WithEvents txtFinanceChargeSalesTax As TextBox
    Friend WithEvents lblAcctNo As Label
    Friend WithEvents lblPaymentWillBe As Label
    Friend WithEvents lblTotalBalance As Label
    Friend WithEvents lblFinanceChargeSalesTax As Label
    Friend WithEvents txtFinanceCharges As TextBox
    Friend WithEvents txtDeferredInt As TextBox
    Friend WithEvents cboCashOption As ComboBox
    Friend WithEvents txtFinanceAmount As TextBox
    Friend WithEvents txtMonthsToFinance As TextBox
    Friend WithEvents lblFinanceCharges As Label
    Friend WithEvents lblDeferredInt As Label
    Friend WithEvents lblCashOpt As Label
    Friend WithEvents lblFinanceAmount As Label
    Friend WithEvents lblMonthsToFinance As Label
    Friend WithEvents txtUnemploymentInsurance As TextBox
    Friend WithEvents txtPropertyInsurance As TextBox
    Friend WithEvents txtAccidentInsurance As TextBox
    Friend WithEvents txtLifeInsurance As TextBox
    Friend WithEvents txtDocFee As TextBox
    Friend WithEvents lblUnemploymentInsurance As Label
    Friend WithEvents lblPropertyInsurance As Label
    Friend WithEvents lblAccidentInsurance As Label
    Friend WithEvents lblLifeInsurance As Label
    Friend WithEvents lblDocFee As Label
    Friend WithEvents lblTotal As Label
    Friend WithEvents lblTotalCaption As Label
    Friend WithEvents txtBalDueLateCharge As TextBox
    Friend WithEvents lblBalDueLateCharge As Label
    Friend WithEvents txtAddlPaymentsMade As TextBox
    Friend WithEvents lblAddlPayments As Label
    Friend WithEvents chkUnemployment As CheckBox
    ...
    Friend WithEvents cboDeferred As ComboBox
