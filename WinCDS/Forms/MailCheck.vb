...
Public Class MailCheck
    ...
    Public Sub LookUpCustomer(ByVal Inp As String, ByRef SelectFromBox As Boolean, Optional ByVal mLine As String = "")
        ...
        If OrderMode("B") Then ' Deliver Sale
            ...
            'Load InvDel
            InvDel.InvDelFormLoad() '<CT> To execute InvelDel form load event. Because in vb6.0, it will execute when Load InvDel(see just above this code line) code line compiles.
